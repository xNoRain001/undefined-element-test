<template>
  <nav class="routing-container flex flex-col items-center h-screen border-[1px] border-y-0 border-l-0 border-gray-500 w-1/6">
...
.routing-container > a {
  @apply text-pink-500 hover:underline mt-4
}
</style>
